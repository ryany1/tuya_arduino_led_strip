...
U 1 1 60B854B2
P 2230 2190
F 0 "#PWR03" H 2230 1940 50  0001 C CNN
F 1 "GND" H 2235 2017 50  0000 C CNN
F 2 "" H 2230 2190 50  0001 C CNN
F 3 "" H 2230 2190 50  0001 C CNN
	1    2230 2190
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 60B9F0F4
P 6190 3120
F 0 "D4" H 6183 3337 50  0000 C CNN
F 1 "LED" H 6183 3246 50  0000 C CNN
F 2 "LED_SMD:LED_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 6190 3120 50  0001 C CNN
...
U 1 1 60BA3AB7
P 6730 3120
F 0 "#PWR014" H 6730 2870 50  0001 C CNN
F 1 "GND" H 6735 2947 50  0000 C CNN
F 2 "" H 6730 3120 50  0001 C CNN
F 3 "" H 6730 3120 50  0001 C CNN
	1    6730 3120
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
U 1 1 60BA5CD5
P 6580 3120
F 0 "R2" V 6787 3120 50  0000 C CNN
F 1 "330" V 6696 3120 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad0.98x0.95mm_HandSolder" V 6510 3120 50  0001 C CNN
F 3 "~" H 6580 3120 50  0001 C CNN
	1    6580 3120
	0    -1   -1   0   
$EndComp
Wire Wire Line
	6040 3120 5870 3120
Text Label 5960 3120 2    50   ~ 0
led_ar
$Comp
...
RX_C
Wire Wire Line
	10430 2270 10580 2270
Wire Wire Line
	10430 2470 10580 2470
Text Label 10440 2270 0    50   ~ 0
RX_C
Text Label 10440 2470 0    50   ~ 0
TX_C
Wire Wire Line
	10430 1870 10730 1870
Text Label 10720 1870 2    50   ~ 0
RST_TU,CEN
$Comp
...
U 1 1 60C33F65
P 5160 3270
F 0 "#PWR010" H 5160 3120 50  0001 C CNN
F 1 "+5V" H 5175 3443 50  0000 C CNN
F 2 "" H 5160 3270 50  0001 C CNN
F 3 "" H 5160 3270 50  0001 C CNN
	1    5160 3270
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	8530 2570 8310 2570
Wire Wire Line
	10650 1270 10430 1270
Wire Wire Line
	10650 1470 10430 1470
Wire Wire Line
	10650 1670 10430 1670
Wire Wire Line
	10650 2070 10430 2070
Wire Wire Line
	10650 2570 10430 2570
Wire Wire Line
	9980 3140 9980 2920
Wire Wire Line
	9780 3140 9780 2920
...
Wire Wire Line
	8730 3140 8730 2920
Text Label 8500 1770 2    50   ~ 0
KEY_TU
Text Label 8510 1370 2    50   ~ 0
P14
Text Label 8450 1570 2    50   ~ 0
OUT_RGB_TU
Text Label 8480 1970 2    50   ~ 0
P22
Text Label 8480 2170 2    50   ~ 0
ADC
Text Label 8490 2370 2    50   ~ 0
RX2
Text Label 8490 2570 2    50   ~ 0
TX2
NoConn ~ 10650 2570
Text Label 10610 2070 2    50   ~ 0
P28
Text Label 10610 1670 2    50   ~ 0
P9
Text Label 10620 1270 2    50   ~ 0
P15
Text Label 10620 1470 2    50   ~ 0
P17
Text Label 9780 3000 2    50   ~ 0
P24
Text Label 9480 3030 2    50   ~ 0
P26
Text Label 9230 3010 2    50   ~ 0
P6
Text Label 8980 3010 2    50   ~ 0
P7
Text Label 8730 3000 2    50   ~ 0
P8
$Comp
...
U 1 1 60E00ABA
P 10180 3140
F 0 "#PWR022" H 10180 2990 50  0001 C CNN
F 1 "+3.3V" H 10195 3313 50  0000 C CNN
F 2 "" H 10180 3140 50  0001 C CNN
F 3 "" H 10180 3140 50  0001 C CNN
	1    10180 3140
	1    0    0    1   
$EndComp
$Comp
...
U 1 1 60E039CA
P 9980 3140
F 0 "#PWR023" H 9980 2890 50  0001 C CNN
F 1 "GND" H 9985 2967 50  0000 C CNN
F 2 "" H 9980 3140 50  0001 C CNN
F 3 "" H 9980 3140 50  0001 C CNN
	1    9980 3140
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 60E053E5
P 10570 3150
F 0 "C8" H 10685 3196 50  0000 L CNN
F 1 "0.1uf" H 10685 3105 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 10608 3000 50  0001 C CNN
F 3 "~" H 10570 3150 50  0001 C CNN
	1    10570 3150
	-1   0    0    -1  
$EndComp
Wire Wire Line
	10570 3000 10180 3000
Wire Wire Line
	10180 2920 10180 3000
Connection ~ 10180 3000
Wire Wire Line
	10180 3000 10180 3140
Wire Wire Line
	10570 3300 10570 3350
$Comp
L power:GND #PWR020
U 1 1 60E15814
P 10570 3350
F 0 "#PWR020" H 10570 3100 50  0001 C CNN
F 1 "GND" H 10575 3177 50  0000 C CNN
F 2 "" H 10570 3350 50  0001 C CNN
F 3 "" H 10570 3350 50  0001 C CNN
	1    10570 3350
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 61009E29
P 10730 4510
F 0 "SW4" H 10730 4795 50  0000 C CNN
F 1 "SW_Push" H 10730 4704 50  0000 C CNN
F 2 "tuya_arduino:button_smd" H 10730 4710 50  0001 C CNN
F 3 "~" H 10730 4710 50  0001 C CNN
	1    10730 4510
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61009E2F
P 10740 4660
F 0 "C10" V 10790 4730 50  0000 L CNN
F 1 "0.1uf" V 10790 4390 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 10778 4510 50  0001 C CNN
F 3 "~" H 10740 4660 50  0001 C CNN
	1    10740 4660
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 61009E35
P 10740 4090
F 0 "C9" V 10810 4160 50  0000 L CNN
F 1 "0.1uf" V 10810 3840 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 10778 3940 50  0001 C CNN
F 3 "~" H 10740 4090 50  0001 C CNN
	1    10740 4090
	0    -1   -1   0   
$EndComp
Wire Wire Line
	10890 4090 11000 4090
Wire Wire Line
	11000 4090 11000 3960
Wire Wire Line
	11000 3960 10940 3960
Wire Wire Line
	10930 4510 11000 4510
Wire Wire Line
	11000 4660 10890 4660
Wire Wire Line
	11000 4090 11000 4510
Connection ~ 11000 4090
Connection ~ 11000 4510
Wire Wire Line
	11000 4510 11000 4660
$Comp
L Switch:SW_Push SW5
U 1 1 61009E46
P 10740 3960
F 0 "SW5" H 10740 4245 50  0000 C CNN
F 1 "SW_Push" H 10740 4154 50  0000 C CNN
F 2 "tuya_arduino:button_smd" H 10740 4160 50  0001 C CNN
F 3 "~" H 10740 4160 50  0001 C CNN
	1    10740 3960
	1    0    0    -1  
$EndComp
Wire Wire Line
	10540 3960 10540 4090
Wire Wire Line
	10540 4090 10590 4090
Wire Wire Line
	10530 4510 10530 4660
Wire Wire Line
	10530 4660 10590 4660
Connection ~ 10530 4510
Wire Wire Line
	10540 3960 10400 3960
Connection ~ 10540 3960
...
U 1 1 6103B003
P 11000 4800
F 0 "#PWR027" H 11000 4550 50  0001 C CNN
...
F 3 "" H 11000 4800 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Connection ~ 11000 4660
Text Label 10460 3960 2    50   ~ 0
RST_TU,CEN
Text Label 10230 4510 0    50   ~ 0
KEY_TU
Wire Wire Line
	10200 4510 10530 4510
$Comp
...
Wire Wire Line
	1780 5950 1910 5950
$Comp
L 自用工程原理图库:mcu_tuya_cbu U2
U 1 1 60F9BA74
P 14680 -1830
F 0 "U2" H 9480 -4315 50  0000 C CNN
F 1 "mcu_tuya_cbu" H 9480 -4406 50  0000 C CNN
F 2 "自用工程封装库:tuya_cbu" H 10030 -4830 50  0001 C CNN
F 3 "" H 10030 -4830 50  0001 C CNN
	1    14680 -1830
	1    0    0    -1  
$EndComp
NoConn ~ 1010 2040
...
U 1 1 6106F3B1
P 5090 3270
F 0 "#FLG0102" H 5090 3345 50  0001 C CNN
F 1 "PWR_FLAG" H 5090 3443 50  0000 C CNN
F 2 "" H 5090 3270 50  0001 C CNN
F 3 "~" H 5090 3270 50  0001 C CNN
	1    5090 3270
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 610709D4
P 4460 1830
F 0 "#FLG0103" H 4460 1905 50  0001 C CNN
F 1 "PWR_FLAG" H 4460 2003 50  0000 C CNN
F 2 "" H 4460 1830 50  0001 C CNN
F 3 "~" H 4460 1830 50  0001 C CNN
	1    4460 1830
	1    0    0    -1  
$EndComp
Connection ~ 4460 1830
Wire Wire Line
	4460 1830 4660 1830
Wire Wire Line
	11000 4660 11000 4800
Wire Wire Line
	610  2440 610  2550
Wire Wire Line
	710  2440 710  2550
...
U 1 1 610B682B
P 4960 2210
F 0 "#PWR0101" H 4960 1960 50  0001 C CNN
F 1 "GND" H 4965 2037 50  0000 C CNN
F 2 "" H 4960 2210 50  0001 C CNN
F 3 "" H 4960 2210 50  0001 C CNN
	1    4960 2210
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 610EE4AD
P 610 2550
F 0 "#FLG0101" H 610 2625 50  0001 C CNN
F 1 "PWR_FLAG" V 610 2677 50  0000 L CNN
F 2 "" H 610 2550 50  0001 C CNN
F 3 "~" H 610 2550 50  0001 C CNN
	1    610  2550
	0    -1   -1   0   
...
U 1 1 60CC5972
P 4840 3270
F 0 "SW6" H 4840 3505 50  0000 C CNN
F 1 "SW_DPST_x2" H 4840 3414 50  0000 C CNN
F 2 "Button_Switch_SMD:SW_SPST_B3U-1000P" H 4840 3270 50  0001 C CNN
F 3 "~" H 4840 3270 50  0001 C CNN
	1    4840 3270
	1    0    0    -1  
$EndComp
Wire Wire Line
